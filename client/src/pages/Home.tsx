          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-2 mt-2 text-xs" style={{ color: "#475569" }}>
                <span style={{ color: "#10b981", fontWeight: 600 }}>v1.0.4</span>
                <span>·</span>
                <span>11 MB</span>
                <span>·</span>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className="text-xs px-2 py-0.5 rounded-full font-semibold" style={{ background: "rgba(16,185,129,0.15)", color: "#10b981", border: "1px solid rgba(16,185,129,0.3)" }}>v1.0.4</span>
