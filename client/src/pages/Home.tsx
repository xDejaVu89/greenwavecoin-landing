...
const DOWNLOAD_EXE_URL = "https://github.com/xDejaVu89/greenwavecoin/releases/download/v1.0.8/GreenWaveCoin-Worker.exe";
              ...
              {referralLink && (
                <div className="mt-2" style={{ background: "rgba(6,182,212,0.06)", border: "1px solid rgba(6,182,212,0.2)", borderRadius: "12px", padding: "20px" }}>
                  ...
                  <div className="flex items-center justify-center gap-4 mt-4">
                    ...
                    <a
                      href="https://discord.gg/RZgnnbjrH4"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-xs font-semibold px-4 py-2 rounded-lg transition-colors"
      ...
      <nav className="fixed top-0 left-0 right-0 z-50" style={{ background: "rgba(2, 11, 24, 0.85)", backdropFilter: "blur(20px)", borderBottom: "1px solid rgba(6, 182, 212, 0.1)" }}>
        <div className="container flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="https://x.com/GreenWaveCoin" target="_blank" rel="noopener noreferrer" className="hidden md:block">
              <Button variant="outline" size="sm" className="gap-2" style={{ borderColor: "rgba(6, 182, 212, 0.4)", color: "#06b6d4", background: "transparent" }}>
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622Zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg> X
              </Button>
            </a>
            <a href="https://discord.gg/RZgnnbjrH4" target="_blank" rel="noopener noreferrer" className="hidden md:block">
              <Button variant="outline" size="sm" className="gap-2" style={{ borderColor: "rgba(6, 182, 212, 0.4)", color: "#06b6d4", background: "transparent" }}>
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-2 mt-2 text-xs" style={{ color: "#475569" }}>
                <span style={{ color: "#10b981", fontWeight: 600 }}>v1.0.8</span>
                <span>·</span>
                <span>11 MB</span>
                <span>·</span>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className="text-xs px-2 py-0.5 rounded-full font-semibold" style={{ background: "rgba(16,185,129,0.15)", color: "#10b981", border: "1px solid rgba(16,185,129,0.3)" }}>v1.0.8</span>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="https://x.com/GreenWaveCoin" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm hover:text-[#06b6d4] transition-colors" style={{ color: "#64748b" }}>
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg> @GreenWaveCoin
                </a>
                <a href="https://discord.gg/RZgnnbjrH4" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm hover:text-[#06b6d4] transition-colors" style={{ color: "#64748b" }}>
